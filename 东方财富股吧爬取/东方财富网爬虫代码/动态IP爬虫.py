...
for num in num_list:
    ...
    proxy='http://api.sgxz.cn:12080/getip?token=cfd32d1b08717771953d98620f09332b&protocol=HTTP&num=200&result_format=JSON&separator=%5Cn&ip_dedup=0&time_avail=1'
    url1 = 'http://guba.eastmoney.com/list,zssh000001,f_{}.html'.format(num)
    response = requests.get(url=url1, headers=headers, proxies={'http': proxy},timeout=15)
