...
df=pd.read_excel(os.path.join(path,'2020year.xlsx'),skiprows=2,usecols=[1,2,3,4],names=['date','title','content','source'],index_col='date',parse_dates=True)
...
df.to_excel(os.path.join(save_path,'2020年.xlsx'))
