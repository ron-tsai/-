...
#                 poscount = 1   # 积极得分+1
#
#                 count_list.append(poscount)
#                 for w in seg_sent[s:i]:
#                     count_list = match(w, count_list)
...
def run_score():
    fp_test = open('C:\\Users\Administrator\Desktop/新闻情感分析.txt', 'r',encoding="utf-8")   # 待处理数据
    contents = []
