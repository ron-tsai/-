...
train_target_start=pd.to_datetime('2019-07-19')
...
print(date_list)
print(close_list)
last_close=3768.402 #2019-07-18
target_list=[]
...
print(df)
df.to_excel('F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\武汉金融复现：大数据量12年起始\\6比2比2\涨跌目标数据\测试集target.xlsx')
