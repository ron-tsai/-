...
print(daily_train_df['high'].mean())
print(daily_train_df['high'].std())

print(daily_train_df['low'].mean())
print(daily_train_df['low'].std())
print(daily_train_df['close'].mean())
print(daily_train_df['close'].std())


print(daily_train_df['volume_rate'].mean())
print(daily_train_df['volume_rate'].std())
...
fif_norm.to_excel('F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\武汉金融复现：大数据量12年起始\\8比1比1\标准化后数据\\fif_train_data.xlsx')
daily_norm.to_excel('F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\武汉金融复现：大数据量12年起始\\8比1比1\标准化后数据\\daily_train_data.xlsx')
