...
train_target_start=pd.to_datetime('2020-06-02')
...
print(df)
df.to_excel('F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\武汉金融复现：大数据量12年起始\\8比1比1\涨跌目标数据\测试集target.xlsx')
