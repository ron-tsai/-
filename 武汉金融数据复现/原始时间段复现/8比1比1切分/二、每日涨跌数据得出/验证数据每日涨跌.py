...
train_target_start=pd.to_datetime('2019-05-23')
train_target_end=pd.to_datetime('2020-03-31')
...
print(df)
df.to_excel('F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\武汉金融复现：大数据量12年起始\\8比1比1\涨跌目标数据\验证集target.xlsx')
