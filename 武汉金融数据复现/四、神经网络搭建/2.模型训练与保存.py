...
##### 二、数据导入
finally_dir='F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\武汉金融复现：大数据量12年起始\标准化后数据'
...
# print(val_gen)
history=model.fit_generator(generator=train_gen,steps_per_epoch=10,validation_data=val_gen,epochs=7)
model.save("初步模型.model")
