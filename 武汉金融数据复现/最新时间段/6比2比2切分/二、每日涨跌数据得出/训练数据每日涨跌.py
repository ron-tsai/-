...
train_target_start=pd.to_datetime('2012-04-26')
train_target_end=pd.to_datetime('2017-06-30')
date_list=[]
close_list=[]
...
df.to_excel('F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\武汉金融复现：大数据量12年起始\\6比2比2\涨跌目标数据\训练集target.xlsx')
