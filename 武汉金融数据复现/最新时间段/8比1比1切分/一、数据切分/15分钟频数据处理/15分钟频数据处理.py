...
#切割数据集
fif_train_df=total_df2.loc[(total_df2['trade_time']>=pd.to_datetime("2012-02-27"))&(total_df2['trade_time']<pd.to_datetime("2017-06-30")),:]
fif_val_df=total_df2.loc[(total_df2['trade_time']>=pd.to_datetime("2017-07-03"))&(total_df2['trade_time']<pd.to_datetime("2019-05-22")),:]
fif_test_df=total_df2.loc[(total_df2['trade_time']>=pd.to_datetime("2019-05-23"))&(total_df2['trade_time']<pd.to_datetime("2021-04-13")),:]
