...
fif_norm.to_excel('F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\武汉金融复现：大数据量12年起始\\8比1比1\标准化后数据\\fif_test_data.xlsx')
daily_norm.to_excel('F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\武汉金融复现：大数据量12年起始\\8比1比1\标准化后数据\\daily_test_data.xlsx')
