...
wenben_df=pd.read_excel(os.path.join(wenben_dir,'wenben_data.xlsx'))
...
history=model.fit(x=[fif_train,daily_train,wenben_long_term_train,wenben_short_term_train],y=target_train,batch_size=8,validation_split=0.2,epochs=18)
