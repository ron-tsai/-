...
origin_data=Data_maker(train_num=1650,test_num=413,fif_back=16,daily_back=20,long_term_back=15,short_term_back=2)
...
wenben_df=pd.read_excel(os.path.join(wenben_dir,'media_index.xlsx'))
...
model=my_model(long_term=15,short_term=2)
