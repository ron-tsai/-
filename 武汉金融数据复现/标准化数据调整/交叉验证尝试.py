...
origin_data=Data_maker(train_num=1980,test_num=240,fif_back=16,daily_back=20)
...
def split_data(train_num,daily_back):
...
daily_train_df=split_data(1980,20)['daily_train_df']
print('日频训练切分：',daily_train_df.shape)
daily_test_df=split_data(1980,20)['daily_test_df']
print('日频测试切分：',daily_test_df.shape)
fif_train_df=split_data(1980,20)['fif_train_df']
print('十五分钟频训练切分：',fif_train_df.shape)
fif_test_df=split_data(1980,20)['fif_test_df']
print('十五分钟频测试切分：',fif_test_df.shape)
target_train_df=split_data(1980,20)['target_train_df']
print('训练目标切分：',target_train_df.shape)
target_test_df=split_data(1980,20)['target_test_df']
...
#                   target=target_train,train_num=1980,
#                   test_num=240,fif_back=16,daily_back=20)
#
