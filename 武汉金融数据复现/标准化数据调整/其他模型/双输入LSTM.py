...
def my_model():
    ...
    LSTM_fif=layers.LSTM(100)(fif_min_input)
    # LSTM_fif2 = layers.LSTM(100)(LSTM_fif1)
...
history=model.fit(x=[fif_train,daily_train],y=train_targets,batch_size=16,validation_data=([fif_val,daily_val],val_targets),epochs=20)
