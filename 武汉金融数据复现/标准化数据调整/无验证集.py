...
origin_data=Data_maker(train_num=1800,test_num=420,fif_back=16,daily_back=20)
...
def split_data(train_num=1800,daily_back=20):
...
history=model.fit(x=[fif_train,daily_train],y=target_train,batch_size=16,validation_data=([fif_test,daily_test],target_test),epochs=60)
