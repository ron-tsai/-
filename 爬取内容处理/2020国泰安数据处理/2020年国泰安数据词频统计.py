...
def get_text(file):
    file='C:\\Users\Administrator\Desktop\国泰安\\2020新闻内容聚合.txt'
...
if __name__ == '__main__':
    words_sort = fp = get_text(r'C:\\Users\Administrator\Desktop\爬取内容\\2020年新闻聚合.txt')
