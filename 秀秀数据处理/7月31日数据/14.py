...
df=pd.read_excel(os.path.join(path,'14.xlsx'),usecols=[0,1,2,3],header=None,skiprows=3,dtype=object,names=['证券代码','截止日期','报表类型','流动资产周转率'])
...
df1.to_excel(os.path.join(path,'14-.xlsx'),index=False)