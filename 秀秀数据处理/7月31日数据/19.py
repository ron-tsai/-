...
df=pd.read_excel(os.path.join(path,'19 .xlsx'),usecols=[0,1,2,3],header=None,skiprows=3,dtype=object,names=['证券代码','截止日期','报表类型','总资产增长率A'])
...
df1.to_excel(os.path.join(path,'19-.xlsx'),index=False)