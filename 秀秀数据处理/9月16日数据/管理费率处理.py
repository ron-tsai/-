...
df=pd.read_excel(os.path.join(path,'管理费用率.xlsx'),dtype=object,index=False,header=None,skiprows=3,names=['证券代码','截止日期','报表类型','管理费用率'])
...
df1.to_excel(os.path.join(path,'管理费用-.xlsx'),index=False)