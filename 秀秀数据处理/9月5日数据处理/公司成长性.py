...
df=pd.read_excel(os.path.join(path,'公司成长性 .xlsx'),usecols=[0,1,2,3],header=None,skiprows=3,dtype=object,names=['证券代码','截止日期','报表类型','营业收入增长率'])
...
df1.to_excel(os.path.join(path,'gongsichengzhangxing.xlsx'),index=False)