...
min_fif_train_data.to_excel('F:\\newstart\software\category\\tool\category\deal_with_data\武汉金融数据\\15分钟数据初步处理\\15min_train_data.xlsx',index=False,columns=['trade_time','open','close','high','low','volume','money'])
