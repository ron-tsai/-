...
# 日频输入训练
daily_input=Input(shape=(20,4),batch_shape=None,dtype='float32',name='daily')
...
# history=model.fit_generator([fif_train_gen,daily_train_gen],steps_per_epoch=10,epochs=100,
#                             validation_data=[fif_val_gen,daily_val_gen],
#                             validation_steps=10)

history=model.fit_generator(generator=[fif_train_gen,daily_train_gen],steps_per_epoch=10,epochs=100,
                            )
