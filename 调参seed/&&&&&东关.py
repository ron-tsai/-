...
x1_train, x1_test, x2_train, x2_test, x3_train, x3_test,y_train, y_test = train_test_split(fif_train,daily_train,wenben_short_term_train, target_train ,test_size=validation_split,random_state=seed,shuffle=True)
print('@@@@@@@@@',x1_train)
...
history=model.fit(x=[x1_train,x2_train,x3_train],y=y_train,batch_size=batch_size,epochs=epochs,validation_data=([x1_test,x2_test,x3_test] ,y_test))
